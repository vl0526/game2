...
const MusicToggleButton: React.FC<MusicToggleButtonProps> = ({ isMusicPlaying, onToggle }) => {
  return (
    <button
      onClick={onToggle}
      className="absolute top-4 right-4 z-50 w-12 h-12 p-2 border-4 rounded-full transition-all duration-200 transform hover:scale-110 focus:outline-none hover:bg-blue-100/50"
